...
class Role(models.Model):
    ...
    url_to_program = models.URLField(verbose_name="URL to bachelor program")
...
class Question(models.Model):
    ...
    positive_choice = models.TextField(verbose_name="positive choice", default="Yes")
    negative_choice = models.TextField(verbose_name="negative choice", default="No")
